...
interface IInputCodUserConfirmProps extends TextInputProps {
  icon: string;
  stringError?: string | null;
  callOnBlur?: Function;
}

const InputCodUserConfirm: React.FC<IInputCodUserConfirmProps> = ({
  icon,
  stringError,
  callOnBlur,
  value,
...
export default InputCodUserConfirm;